...
suppressPackageStartupMessages(library(dplyr)) # <-- install via Bionconductor (part of the "Tidyverse")
suppressPackageStartupMessages(library(Biobase))
suppressPackageStartupMessages(library(edgeR)) # <-- install via Bioconductor
suppressPackageStartupMessages(library(parallel)) # <-- built-in to R

#save.image(paste0("/mnt/beegfs/scratch/h_herrmann/rollup.RData"))
#load("/mnt/beegfs/scratch/h_herrmann/rollup.RData")
