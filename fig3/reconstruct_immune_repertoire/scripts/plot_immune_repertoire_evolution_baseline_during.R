...
get_pvalues_paired_test <- function(df_1, df_2) {
   ...
   pval_df <- data.frame(BCR_reads = NA_real_,
                         ...
                         TCR_reads = NA_real_,
                         TCR_ratio = NA_real_,
                         TCR_diversity = NA_real_,
                         BCR_diversity = NA_real_,
                         SHM_ratio = NA_real_,
...
baseline <- "/mnt/beegfs/userdata/h_herrmann/mela_ici_response_results/reconstruct_immune_repertoire/gr1234/trust4/overall_stats.tsv"
during <- "/mnt/beegfs/userdata/h_herrmann/mela_ici_response_results/reconstruct_immune_repertoire/gr1234/trust4_during/overall_stats.tsv"
design <- "/mnt/beegfs/userdata/h_herrmann/design/gr1234/baseline_curated_design_gr1234.tsv"
out_dir <- "/mnt/beegfs/userdata/h_herrmann/mela_ici_response_results/reconstruct_immune_repertoire/gr1234/trust4_during/"
...
#
# --------------------------------------------
vars <- c("BCR_clonality", "BCR_diversity", "TCR_clonality", "TCR_diversity")
...
for (i in vars) {
   ...
   ggsave(paste0(out_dir, i, ".pdf"), plot, width = 4, height = 5)
   ggsave(paste0(out_dir, i, ".svg"), plot, width = 4, height = 5)
}
...
all_plot <- ggarrange(bcr_clonality_plot, cpk_bcr_plot,
                      cpk_tcr_plot, tcr_clonality_plot, 
                      nrow = 2, ncol = 2)
