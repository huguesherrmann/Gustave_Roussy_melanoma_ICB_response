...
# design_path <- "/mnt/beegfs/userdata/h_herrmann/design/gr1234/baseline_curated_design_gr1234.tsv"
...
boxplot_estimate <- ggplot(design, aes(x = Response, y = Tumor_purity, fill = Response)) +
  ...
  stat_compare_means(method = "wilcox.test", label = "p.format", label.x = 1.15, label.y = 0.985, size = 6.5) +
  ylim(0, 1) +
  guides(fill = "none")
...
#
# ......................................................
write.table(design, design_path, sep = "\t", quote = TRUE, row.names = FALSE)

write.table(epic, paste0(out_dir, "/deconvolution/EPIC_estimations.tsv"), sep = "\t", quote = FALSE, row.names = FALSE)
write.table(quantiseq, paste0(out_dir, "/deconvolution/quanTIseq_estimations.tsv"), sep = "\t", quote = FALSE, row.names = FALSE)
write.table(estimate, paste0(out_dir, "/deconvolution/ESTIMATE_estimations.tsv"), sep = "\t", quote = FALSE, row.names = FALSE)
write.table(mcpcounter, paste0(out_dir, "/deconvolution/MCPcounter_estimations.tsv"), sep = "\t", quote = FALSE, row.names = FALSE)

ggsave(paste0(out_dir, "/deconvolution/paired_violin_EPIC.svg"), plot_violin_epic, width = 10, height = 10)
ggsave(paste0(out_dir, "/deconvolution/paired_violin_EPIC.png"), plot_violin_epic, width = 10, height = 10)
ggsave(paste0(out_dir, "/deconvolution/paired_violin_EPIC.pdf"), plot_violin_epic, width = 10, height = 10)

ggsave(paste0(out_dir, "/deconvolution/paired_violin_quanTIseq.svg"), plot_violin_quantiseq, width = 10, height = 10)
ggsave(paste0(out_dir, "/deconvolution/paired_violin_quanTIseq.png"), plot_violin_quantiseq, width = 10, height = 10)
ggsave(paste0(out_dir, "/deconvolution/paired_violin_quanTIseq.pdf"), plot_violin_quantiseq, width = 10, height = 10)

ggsave(paste0(out_dir, "/deconvolution/paired_violin_MCPcounter.svg"), plot_violin_mcpcounter, width = 10, height = 10)
ggsave(paste0(out_dir, "/deconvolution/paired_violin_MCPcounter.png"), plot_violin_mcpcounter, width = 10, height = 10)
ggsave(paste0(out_dir, "/deconvolution/paired_violin_MCPcounter.pdf"), plot_violin_mcpcounter, width = 10, height = 10)

ggsave(paste0(out_dir, "/deconvolution/tumor_purity_vs_response_box.svg"), boxplot_estimate, width = 3, height = 4)
ggsave(paste0(out_dir, "/deconvolution/tumor_purity_vs_response_box.png"), boxplot_estimate, width = 3, height = 4)
ggsave(paste0(out_dir, "/deconvolution/tumor_purity_vs_response_box.pdf"), boxplot_estimate, width = 3, height = 4)
