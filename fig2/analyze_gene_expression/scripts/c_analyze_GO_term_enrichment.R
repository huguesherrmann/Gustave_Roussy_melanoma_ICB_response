...
#
# ......................................................
write.table(go, paste0(out_dir, cohort, "/GO_terms/go_terms.tsv"), sep = "\t", quote = FALSE, row.names = FALSE)

svg(paste0(out_dir, cohort, "/GO_terms/go_terms.svg"))
treemapPlot(reduced_terms)
dev.off()
png(paste0(out_dir, cohort, "/GO_terms/go_terms.png"))
treemapPlot(reduced_terms)
dev.off()